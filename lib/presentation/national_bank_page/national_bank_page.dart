...
import 'package:urbank/widgets/app_bar/appbar_iconbutton_2.dart';
...
class NationalBankPage extends StatelessWidget {
  NationalBankController controller =
      Get.put(NationalBankController(NationalBankModel().obs));
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Obx(() => ListView.separated(
                              ...
                              itemCount: controller.nationalBankModelObj.value
                                  .nationalbankItemList.value.length,
                              itemBuilder: (context, index) {
                                NationalbankItemModel model = controller
